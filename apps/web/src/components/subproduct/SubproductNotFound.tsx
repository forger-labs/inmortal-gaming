...
interface SubproductNotFoundProps {
  message?: string;
  onRetry?: () => void;
}

export function SubproductNotFound({
  message = "No se pudo encontrar la informacion del subproducto solicitado.",
  onRetry,
}: SubproductNotFoundProps) {
  return (
